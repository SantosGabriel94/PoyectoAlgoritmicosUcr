...
public class CreateProfilesJP2 extends javax.swing.JPanel {
    ...
    private void btnCreatProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreatProfileActionPerformed
       String profileName = txtProfileName.getText().trim();
        ...
        if (user.agregarPerfil(profileName, age)) {
            login.saveUsers();
            int option = JOptionPane.showConfirmDialog(this, "Perfil creado exitosamente. ¿Desea agregar otro perfil?", "Perfil Creado", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
   ...
   private void changeToProfileUserPanel() {
       // Asegúrate de tener acceso a 'login' y 'username' aquí, o pásalos como parámetros al método si es necesario
